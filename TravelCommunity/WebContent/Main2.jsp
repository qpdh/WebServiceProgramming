  ...
  transform: rotateY(180deg);
	...
	<center>
		<div class='menu'>
			...
			<br>
				<li>
					<a href='index.html'>여행지</a>
				</li>
				
				<li>
					<a href='intro.html'>커뮤니티</a>
				<li>
					<img src="images/user2.png" alt="" /><a href='intro.html'></a>
				</li>
				</li>
			</ul>
		</div>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="container">
					<ul class="icons">
						<li><a href="http://twitter.com/intent/tweet?text=" class="icon fa-twitter"><span class="label">Twitter</span></a></li>

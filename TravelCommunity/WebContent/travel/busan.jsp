		...
		<div id="carousel-example-generic" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img id="s" src="../images/Haeundae Beach.jpg" alt="">
				</div>
				<div class="item">
					<img id="s" src="../images/Busan Tower.jpg" alt="">
				</div>
				<div class="item">
					<img id="s" src="../images/Haedong Yonggung Temple.jpg" alt="">
				</div>
				<!-- Controls -->
